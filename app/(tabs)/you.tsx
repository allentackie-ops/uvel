...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    kicker: { color: colors.muted, letterSpacing: 1.8, fontSize: 11, fontWeight: "600" },
    ...
    ownerLine: { color: colors.muted, fontSize: 13, marginTop: 4 },
    ...
    inviteP: { color: colors.muted, fontSize: 13, marginTop: 4 },
    ...
    inviteNo: { height: 34, paddingHorizontal: 16, borderRadius: 17, borderWidth: 1, borderColor: colors.subtle, alignItems: "center", justifyContent: "center" },
    inviteNoTxt: { color: colors.bone, fontWeight: "700", fontSize: 13 },
    brandArea: { marginBottom: 8 },
    sectionLabel: { color: colors.muted, letterSpacing: 1.6, fontSize: 10, fontWeight: "800", marginTop: 22, marginBottom: 9 },
    brandAreaLabel: { color: colors.muted, letterSpacing: 1.6, fontSize: 10, fontWeight: "800", marginTop: 10, marginBottom: 9 },
    brandCard: {
      marginTop: 16,
    ...
    brandK: { color: colors.muted, letterSpacing: 1.4, fontSize: 10, fontWeight: "700" },
    brandName: { color: colors.bone, fontWeight: "700", fontSize: 17 },
    brandP: { color: colors.muted, fontSize: 13, marginTop: 4 },
    ...
    dnaSum: { color: colors.muted, fontSize: 13, marginTop: 4 },
    dnaChevron: { color: colors.muted, fontSize: 22, marginTop: -6 },
    lede: { color: colors.muted, fontSize: 15, lineHeight: 22, marginTop: 12 },
    foot: { color: colors.muted, fontSize: 13, lineHeight: 19, marginTop: 16 },
    plan: {
      marginTop: 10,
      backgroundColor: colors.surface,
      borderRadius: 20,
    ...
    planP: { color: colors.muted, marginTop: 4, fontSize: 13 },
    ...
    tabTxt: { color: colors.muted, fontSize: 15, fontWeight: "600" },
    ...
    draftImgEmpty: { width: 82, height: 104, borderRadius: 12, backgroundColor: colors.surface, borderWidth: 1, borderStyle: "dashed", borderColor: colors.subtle, alignItems: "center", justifyContent: "center" },
    ...
    draftDetails: { color: colors.muted, fontSize: 12, marginTop: 4 },
    ...
    likerP: { color: colors.muted, fontSize: 13, marginTop: 2 },
    likerT: { color: colors.muted, fontSize: 12, marginTop: 2 },
    ...
    emptyP: { color: colors.muted, fontSize: 15, textAlign: "center", marginTop: 8, lineHeight: 21 },
    start: {
      marginTop: 22,
      height: 48,
