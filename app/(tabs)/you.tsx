...
const art = StyleSheet.create({
  ...
  bar: { position: "absolute", top: 8, left: 8, right: 8, height: 6, borderRadius: 3, backgroundColor: alpha(colors.legacyText, 0.55) },
  legL: { position: "absolute", top: 8, left: 10, width: 6, height: 92, borderRadius: 3, backgroundColor: alpha(colors.legacyText, 0.45) },
  legR: { position: "absolute", top: 8, right: 10, width: 6, height: 92, borderRadius: 3, backgroundColor: alpha(colors.legacyText, 0.45) },
...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    title: { color: colors.legacyText, fontWeight: "700", fontSize: 28, marginTop: 8, lineHeight: 34, flexShrink: 1 },
    ownerBrandLogo: { width: 19, height: 19, borderRadius: 5, marginLeft: 1, transform: [{ translateY: 3 }] },
    ownerLine: { color: alpha(colors.legacyText, 0.5), fontSize: 13, marginTop: 4 },
    invite: { marginTop: 16, backgroundColor: colors.legacySurface, borderRadius: 18, padding: 16 },
    inviteH: { color: colors.legacyText, fontWeight: "700", fontSize: 16 },
    inviteP: { color: alpha(colors.legacyText, 0.5), fontSize: 13, marginTop: 4 },
    inviteRow: { flexDirection: "row", gap: 8, marginTop: 12 },
    inviteYes: { height: 34, paddingHorizontal: 16, borderRadius: 17, backgroundColor: colors.legacyText, alignItems: "center", justifyContent: "center" },
    inviteYesTxt: { color: colors.legacyInk, fontWeight: "800", fontSize: 13 },
    inviteNo: { height: 34, paddingHorizontal: 16, borderRadius: 17, borderWidth: 1, borderColor: alpha(colors.legacyText, 0.16), alignItems: "center", justifyContent: "center" },
    inviteNoTxt: { color: colors.legacyText, fontWeight: "700", fontSize: 13 },
    brandArea: { marginBottom: 8 },
    sectionLabel: { color: alpha(colors.legacyText, 0.42), letterSpacing: 1.6, fontSize: 10, fontWeight: "800", marginTop: 22, marginBottom: 9 },
    brandAreaLabel: { color: alpha(colors.legacyText, 0.42), letterSpacing: 1.6, fontSize: 10, fontWeight: "800", marginTop: 10, marginBottom: 9 },
    brandCard: {
      marginTop: 16,
    ...
    brandK: { color: alpha(colors.legacyText, 0.42), letterSpacing: 1.4, fontSize: 10, fontWeight: "700" },
    brandName: { color: colors.legacyText, fontWeight: "700", fontSize: 17 },
    brandP: { color: alpha(colors.legacyText, 0.5), fontSize: 13, marginTop: 4 },
    brandGo: { color: colors.legacyText, fontWeight: "700", fontSize: 13 },
    brandCardMain: { flex: 1, flexDirection: "row", alignItems: "center", minWidth: 0 },
    brandHQButton: { marginLeft: 12, minWidth: 44, height: 36, paddingHorizontal: 12, borderRadius: 18, backgroundColor: colors.legacyText, alignItems: "center", justifyContent: "center" },
    brandHQText: { color: colors.legacyInk, fontWeight: "800", fontSize: 12, letterSpacing: 0.4 },
    top: { flexDirection: "row", alignItems: "center", marginBottom: 8 },
    faceBtn: { marginRight: 8, marginTop: 4 },
    avatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.legacySurfaceAlt },
    initials: {
      width: 48,
      height: 48,
      borderRadius: 24,
    ...
    initialsTxt: { color: colors.legacyInk, fontWeight: "800", fontSize: 15 },
    faceDot: {
      position: "absolute",
      right: -2,
      bottom: -2,
    ...
    dash: { width: 16, height: 1.5, borderRadius: 1, backgroundColor: colors.legacyText },
    h2: { color: colors.legacyText, fontFamily: "Georgia", fontSize: 26, marginTop: 22 },
    nextCard: { marginTop: 2, backgroundColor: colors.legacyText, borderRadius: 20, padding: 16, flexDirection: "row", alignItems: "center", gap: 12 },
    nextK: { color: "rgba(22,20,15,0.52)", letterSpacing: 1.4, fontSize: 10, fontWeight: "800" },
    nextTitle: { color: colors.legacyInk, fontWeight: "800", fontSize: 19, marginTop: 4 },
    nextP: { color: "rgba(22,20,15,0.62)", fontSize: 13, marginTop: 4, lineHeight: 18 },
    nextAction: { color: colors.legacyInk, fontWeight: "800", fontSize: 13 },
    dnaHead: {
      marginTop: 0,
      backgroundColor: colors.legacySurface,
      borderRadius: 18,
    ...
    toolRow: { marginTop: 10, backgroundColor: colors.legacySurface, borderRadius: 18, padding: 16, flexDirection: "row", alignItems: "center", gap: 12 },
    ...
    dnaTitle: { color: colors.legacyText, fontWeight: "700", fontSize: 17 },
    dnaSum: { color: alpha(colors.legacyText, 0.5), fontSize: 13, marginTop: 4 },
    dnaChevron: { color: alpha(colors.legacyText, 0.55), fontSize: 22, marginTop: -6 },
    lede: { color: alpha(colors.legacyText, 0.58), fontSize: 15, lineHeight: 22, marginTop: 12 },
    foot: { color: alpha(colors.legacyText, 0.4), fontSize: 13, lineHeight: 19, marginTop: 16 },
    plan: {
      marginTop: 10,
      backgroundColor: colors.legacySurface,
      borderRadius: 20,
    ...
    planH: { color: colors.legacyText, fontWeight: "700", fontSize: 16 },
    planP: { color: alpha(colors.legacyText, 0.5), marginTop: 4, fontSize: 13 },
    planGo: { color: colors.legacyText, fontWeight: "700", fontSize: 13 },
    tabs: {
      flexDirection: "row",
      marginTop: 2,
      borderBottomWidth: StyleSheet.hairlineWidth,
      borderBottomColor: alpha(colors.legacyText, 0.12),
    },
    tab: { flex: 1, alignItems: "center", paddingBottom: 12 },
    tabTxt: { color: alpha(colors.legacyText, 0.42), fontSize: 15, fontWeight: "600" },
    tabOn: { color: colors.legacyText },
    tabLine: { position: "absolute", bottom: 0, height: 2, left: 8, right: 8, backgroundColor: colors.legacyText, borderRadius: 1 },
    activeRow: { marginTop: 18, marginBottom: 8 },
    active: { color: colors.legacyText, fontSize: 16, fontWeight: "700", marginTop: 16, marginBottom: 8 },
    ...
    draftCard: { flexDirection: "row", alignItems: "center", gap: 12, padding: 10, borderRadius: 18, backgroundColor: colors.legacySurface, marginTop: 2 },
    draftImg: { width: 82, height: 104, borderRadius: 12, backgroundColor: colors.legacySurfaceAlt },
    draftImgEmpty: { width: 82, height: 104, borderRadius: 12, backgroundColor: colors.legacySurfaceAlt, borderWidth: 1, borderStyle: "dashed", borderColor: alpha(colors.legacyText, 0.24), alignItems: "center", justifyContent: "center" },
    draftImgPlus: { color: colors.legacyText, fontSize: 28 },
    ...
    draftName: { color: colors.legacyText, fontSize: 15, fontWeight: "700", marginTop: 7 },
    draftDetails: { color: alpha(colors.legacyText, 0.55), fontSize: 12, marginTop: 4 },
    draftProgress: { color: colors.warning, fontSize: 12, fontWeight: "700", marginTop: 8 },
    draftArrow: { color: colors.legacyText, fontSize: 30, marginRight: 4 },
    liker: {
      flexDirection: "row",
      alignItems: "center",
      paddingVertical: 10,
    ...
    likerInit: { color: colors.legacyText, fontWeight: "700", fontSize: 16 },
    likerName: { color: colors.legacyText, fontWeight: "700", fontSize: 15 },
    likerP: { color: alpha(colors.legacyText, 0.55), fontSize: 13, marginTop: 2 },
    likerT: { color: alpha(colors.legacyText, 0.38), fontSize: 12, marginTop: 2 },
    likerThumb: { width: 48, height: 64, borderRadius: 8, backgroundColor: colors.legacySurfaceAlt },
    grid: { flexDirection: "row", flexWrap: "wrap", gap: 12, marginTop: 8 },
    empty: { alignItems: "center", paddingTop: 54, paddingBottom: 28, paddingHorizontal: 24 },
    emptyH: { color: colors.legacyText, fontSize: 20, fontWeight: "800", textAlign: "center" },
    emptyP: { color: alpha(colors.legacyText, 0.55), fontSize: 15, textAlign: "center", marginTop: 8, lineHeight: 21 },
    start: {
      marginTop: 22,
      height: 48,
    ...
    startTxt: { color: colors.legacyInk, fontWeight: "800", fontSize: 16 },
    ...
    chipTxt: { color: colors.legacyText, fontWeight: "600", fontSize: 13 },
    ...
    earnTxt: { color: colors.legacyText, fontWeight: "700", fontSize: 13 },
    order: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12 },
    orderImg: { width: 64, height: 80, borderRadius: 10, backgroundColor: colors.legacySurfaceAlt },
    orderName: { color: colors.legacyText, fontWeight: "600", fontSize: 15 },
    orderPrice: { color: colors.legacyText, fontWeight: "700", marginTop: 4 },
    tag: {
      height: 26,
    ...
    tagTxt: { color: alpha(colors.legacyText, 0.7), fontSize: 11, fontWeight: "700" },
    likeCard: { backgroundColor: colors.legacySurface, borderRadius: 18, overflow: "hidden" },
    likeImg: { width: "100%", height: COL * 1.25, backgroundColor: colors.legacySurfaceAlt },
    likeName: { color: colors.legacyText, fontWeight: "600", fontSize: 13, paddingHorizontal: 10, paddingTop: 10 },
    likePrice: { color: colors.legacyText, fontWeight: "700", fontSize: 13, paddingHorizontal: 10, paddingBottom: 12, marginTop: 4 },
  });
}
