...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    aiPill: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: 7, minHeight: 44, paddingHorizontal: 10, borderRadius: 13, borderWidth: 1, borderColor: colors.success, backgroundColor: "rgba(11,10,8,0.74)", marginBottom: 9 },
