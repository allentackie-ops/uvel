...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    chatHeaderButton: { width: 48, height: 48, borderRadius: 24, backgroundColor: `${colors.bone}9E`, borderWidth: 1, borderColor: `${colors.bone}52`, alignItems: "center", justifyContent: "center" },
    ...
    searchFab: {
      ...
      height: 46,
      borderRadius: 23,
      backgroundColor: `${colors.bone}F5`,
      alignItems: "center",
      justifyContent: "center",
    },
