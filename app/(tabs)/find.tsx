...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    syncNotice: { color: colors.muted, fontSize: 12, lineHeight: 18, marginHorizontal: 20, marginTop: 10, marginBottom: 4 },
    lede: { color: colors.muted, fontSize: 16, lineHeight: 23, paddingHorizontal: 20, marginTop: 8, marginBottom: 18 },
    heroNeed: { height: 360 },
    sourceCard: { marginTop: 24, marginHorizontal: 16, padding: 16, borderRadius: 20, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.subtle },
    ...
    sourceCopy: { color: colors.muted, fontSize: 13, lineHeight: 19, marginTop: 4 },
    step: { color: colors.muted, fontSize: 11, fontWeight: "800" },
    ...
    needP: { color: colors.muted, textAlign: "center", marginBottom: 8 },
    ...
    removePhoto: { backgroundColor: colors.ink, borderWidth: 1, borderColor: colors.subtle, height: 36, paddingHorizontal: 16, borderRadius: 18, alignItems: "center", justifyContent: "center" },
    removePhotoTxt: { color: colors.muted, fontSize: 13, fontWeight: "600" },
    headRow: {
      flexDirection: "row",
      alignItems: "baseline",
      justifyContent: "space-between",
    ...
    seeAll: { color: colors.muted, fontSize: 15 },
    ...
    uvelOn: { borderColor: colors.subtle },
    ...
    selectedCopy: { color: colors.muted, fontSize: 13, marginTop: 4 },
    allowance: { color: colors.muted, textAlign: "center", fontSize: 12, marginTop: 10 },
    trust: { color: colors.muted, textAlign: "center", fontSize: 11, lineHeight: 16, paddingHorizontal: 28, marginTop: 10 },
    chip: {
      height: 42,
      paddingHorizontal: 16,
      borderRadius: 21,
