          ...
          {showLink ? (
            <View style={styles.linkRow}>
              <TextInput
                ...
                placeholderTextColor={alpha(colors.bone, 0.35)}
                value={link}
...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    syncNotice: { color: alpha(colors.bone, 0.62), fontSize: 12, lineHeight: 18, marginHorizontal: 20, marginTop: 10, marginBottom: 4 },
    lede: { color: alpha(colors.bone, 0.64), fontSize: 16, lineHeight: 23, paddingHorizontal: 20, marginTop: 8, marginBottom: 18 },
    heroNeed: { height: 360 },
    sourceCard: { marginTop: 24, marginHorizontal: 16, padding: 16, borderRadius: 20, backgroundColor: colors.surface, borderWidth: 1, borderColor: alpha(colors.bone, 0.12) },
    ...
    sourceCopy: { color: alpha(colors.bone, 0.58), fontSize: 13, lineHeight: 19, marginTop: 4 },
    step: { color: alpha(colors.bone, 0.42), fontSize: 11, fontWeight: "800" },
    ...
    needP: { color: alpha(colors.bone, 0.62), textAlign: "center", marginBottom: 8 },
    ...
    needBtnTxt: { color: colors.ink, fontWeight: "700" },
    needBtnGhost: {
      height: 44,
      paddingHorizontal: 20,
      borderRadius: 22,
    ...
    removePhoto: { backgroundColor: alpha(colors.ink, 0.82), borderWidth: 1, borderColor: alpha(colors.bone, 0.18), height: 36, paddingHorizontal: 16, borderRadius: 18, alignItems: "center", justifyContent: "center" },
    removePhotoTxt: { color: alpha(colors.bone, 0.72), fontSize: 13, fontWeight: "600" },
    headRow: {
      flexDirection: "row",
      alignItems: "baseline",
      justifyContent: "space-between",
    ...
    seeAll: { color: alpha(colors.bone, 0.42), fontSize: 15 },
    ...
    uvelOn: { borderColor: alpha(colors.bone, 0.28) },
    ...
    tryingTxt: { color: colors.ink, fontSize: 11, fontWeight: "700" },
    ...
    empty: { color: alpha(colors.bone, 0.58), fontSize: 13, lineHeight: 19 },
    ...
    selected: { marginHorizontal: 20, marginTop: 24, padding: 16, borderRadius: 18, borderWidth: 1, borderColor: alpha(colors.success, 0.28), backgroundColor: alpha(colors.success, 0.06) },
    ...
    selectedCopy: { color: alpha(colors.bone, 0.58), fontSize: 13, marginTop: 4 },
    allowance: { color: alpha(colors.bone, 0.48), textAlign: "center", fontSize: 12, marginTop: 10 },
    trust: { color: alpha(colors.bone, 0.34), textAlign: "center", fontSize: 11, lineHeight: 16, paddingHorizontal: 28, marginTop: 10 },
    chip: {
      height: 42,
      paddingHorizontal: 16,
      borderRadius: 21,
    ...
    ctaOff: { opacity: 0.45 },
    ctaTxt: { color: colors.ink, fontWeight: "700", fontSize: 16 },
    ctaTxtOff: { color: colors.ink },
    ghostCta: {
      marginHorizontal: 16,
      marginTop: 10,
      height: 54,
