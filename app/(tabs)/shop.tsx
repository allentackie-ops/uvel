...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    syncCard: { marginTop: 18, padding: 16, borderRadius: 18, backgroundColor: colors.surface, borderWidth: 1, borderColor: alpha(colors.bone, 0.12) },
    ...
    syncNotice: { color: alpha(colors.bone, 0.6), fontSize: 13, lineHeight: 18, marginTop: 5 },
    ...
    syncSecondary: { minHeight: 40, paddingHorizontal: 16, borderRadius: 20, borderWidth: 1, borderColor: alpha(colors.bone, 0.18), alignItems: "center", justifyContent: "center" },
    ...
    emptyCopy: { color: alpha(colors.bone, 0.58), fontSize: 13, lineHeight: 19, textAlign: "center", marginTop: 6 },
    emptyPrimary: { marginTop: 16, minHeight: 44, paddingHorizontal: 18, borderRadius: 22, backgroundColor: colors.bone, alignItems: "center", justifyContent: "center" },
    emptyPrimaryTxt: { color: colors.ink, fontSize: 13, fontWeight: "800" },
    ...
    campaignSub: { color: alpha(colors.bone, 0.52), fontSize: 13, marginTop: 3 },
    ...
    campaignBrand: { flexShrink: 1, color: alpha(colors.bone, 0.58), fontSize: 11, fontWeight: "800", letterSpacing: 0.7 },
    campaignTitle: { color: colors.bone, fontSize: 17, lineHeight: 20, fontWeight: "700", marginTop: 6 },
    campaignBody: { color: alpha(colors.bone, 0.58), fontSize: 12, lineHeight: 16, marginTop: 4 },
    ...
    brandHeadGo: { color: alpha(colors.bone, 0.45), fontSize: 22, marginTop: -2 },
    ...
    houseLine: { color: alpha(colors.bone, 0.5), fontSize: 12, marginTop: 3 },
    look: { color: alpha(colors.bone, 0.62), marginTop: 6, fontSize: 16 },
    frame: {
      marginTop: 16,
      height: 420,
      borderRadius: 16,
    ...
    storeTxt: { color: alpha(colors.bone, 0.5), fontSize: 15 },
    storeGo: { color: alpha(colors.bone, 0.72), fontSize: 15, textDecorationLine: "underline" },
    search: {
      marginTop: 18,
      height: 46,
      borderRadius: 23,
    ...
    searchIcon: { color: alpha(colors.bone, 0.4), fontSize: 16, marginTop: -1 },
    ...
    clear: { color: alpha(colors.bone, 0.82), fontSize: 22, paddingHorizontal: 4 },
    ...
    count: { color: alpha(colors.bone, 0.4), fontSize: 13, marginBottom: 12 },
