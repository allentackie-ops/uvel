...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    title: { color: colors.legacyText, fontFamily: "Georgia", fontSize: 34, lineHeight: 38, flex: 1 },
    titleRow: { flexDirection: "row", alignItems: "center", gap: 10 },
    syncCard: { marginTop: 18, padding: 16, borderRadius: 18, backgroundColor: colors.legacySurface, borderWidth: 1, borderColor: alpha(colors.legacyText, 0.12) },
    syncKicker: { color: "#D6E27A", fontSize: 10, fontWeight: "800", letterSpacing: 1.4 },
    syncTitle: { color: colors.legacyText, fontSize: 17, fontWeight: "800", marginTop: 5 },
    syncNotice: { color: alpha(colors.legacyText, 0.6), fontSize: 13, lineHeight: 18, marginTop: 5 },
    syncActions: { flexDirection: "row", gap: 8, marginTop: 14 },
    syncPrimary: { minHeight: 40, paddingHorizontal: 16, borderRadius: 20, backgroundColor: colors.legacyText, alignItems: "center", justifyContent: "center" },
    syncPrimaryTxt: { color: colors.legacyInk, fontSize: 13, fontWeight: "800" },
    syncSecondary: { minHeight: 40, paddingHorizontal: 16, borderRadius: 20, borderWidth: 1, borderColor: alpha(colors.legacyText, 0.18), alignItems: "center", justifyContent: "center" },
    syncSecondaryTxt: { color: colors.legacyText, fontSize: 13, fontWeight: "700" },
    emptyState: { marginTop: 22, padding: 22, borderRadius: 20, backgroundColor: colors.legacySurface, alignItems: "center" },
    emptyKicker: { color: "#D6E27A", fontSize: 10, fontWeight: "800", letterSpacing: 1.5 },
    emptyTitle: { color: colors.legacyText, fontSize: 19, fontWeight: "800", textAlign: "center", marginTop: 7 },
    emptyCopy: { color: alpha(colors.legacyText, 0.58), fontSize: 13, lineHeight: 19, textAlign: "center", marginTop: 6 },
    emptyPrimary: { marginTop: 16, minHeight: 44, paddingHorizontal: 18, borderRadius: 22, backgroundColor: colors.legacyText, alignItems: "center", justifyContent: "center" },
    emptyPrimaryTxt: { color: colors.legacyInk, fontSize: 13, fontWeight: "800" },
    ...
    campaignSub: { color: alpha(colors.legacyText, 0.52), fontSize: 13, marginTop: 3 },
    campaignLive: { color: colors.legacyInk, backgroundColor: "#D6E27A", borderRadius: 11, paddingHorizontal: 9, paddingVertical: 5, fontSize: 10, fontWeight: "800", letterSpacing: 1 },
    campaignRail: { gap: 10, paddingBottom: 4 },
    campaignCard: { width: 292, minHeight: 148, borderRadius: 16, overflow: "hidden", backgroundColor: colors.legacySurface, flexDirection: "row" },
    campaignImg: { width: 106, height: "100%", minHeight: 148, backgroundColor: colors.legacySurfaceAlt },
    ...
    campaignLogo: { width: 18, height: 18, borderRadius: 5, backgroundColor: colors.legacySurfaceAlt },
    campaignBrand: { flexShrink: 1, color: alpha(colors.legacyText, 0.58), fontSize: 11, fontWeight: "800", letterSpacing: 0.7 },
    campaignTitle: { color: colors.legacyText, fontSize: 17, lineHeight: 20, fontWeight: "700", marginTop: 6 },
    campaignBody: { color: alpha(colors.legacyText, 0.58), fontSize: 12, lineHeight: 16, marginTop: 4 },
    ...
    brandHeadTxt: { color: colors.legacyText, fontWeight: "700", fontSize: 18 },
    brandHeadGo: { color: alpha(colors.legacyText, 0.45), fontSize: 22, marginTop: -2 },
    ...
    houseLogo: { width: 56, height: 56, borderRadius: 12, backgroundColor: colors.legacySurfaceAlt },
    houseMeta: { flex: 1, paddingRight: 4 },
    houseName: { color: colors.legacyText, fontWeight: "700", fontSize: 14, flexShrink: 1 },
    houseLine: { color: alpha(colors.legacyText, 0.5), fontSize: 12, marginTop: 3 },
    look: { color: alpha(colors.legacyText, 0.62), marginTop: 6, fontSize: 16 },
    frame: {
      marginTop: 16,
      height: 420,
      borderRadius: 16,
      backgroundColor: colors.legacyPage,
    },
    orbitBox: { paddingVertical: 48, alignItems: "center" },
    store: { flexDirection: "row", alignItems: "center", marginTop: 8, gap: 6 },
    storeTxt: { color: alpha(colors.legacyText, 0.5), fontSize: 15 },
    storeGo: { color: alpha(colors.legacyText, 0.72), fontSize: 15, textDecorationLine: "underline" },
    search: {
      marginTop: 18,
      height: 46,
      borderRadius: 23,
      ...
      borderWidth: 1,
      borderColor: alpha(colors.legacyText, 0.12),
      flexDirection: "row",
      alignItems: "center",
      paddingHorizontal: 14,
      gap: 8,
    },
    searchIcon: { color: alpha(colors.legacyText, 0.4), fontSize: 16, marginTop: -1 },
    input: { flex: 1, color: colors.legacyText, fontSize: 16, height: 46 },
    clearBtn: { minWidth: 44, minHeight: 44, alignItems: "center", justifyContent: "center" },
    clear: { color: alpha(colors.legacyText, 0.82), fontSize: 22, paddingHorizontal: 4 },
    ...
    count: { color: alpha(colors.legacyText, 0.4), fontSize: 13, marginBottom: 12 },
