...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    syncSecondary: { minHeight: 40, paddingHorizontal: 16, borderRadius: 20, borderWidth: 1, borderColor: colors.subtle, alignItems: "center", justifyContent: "center" },
    ...
    campaignBrand: { flexShrink: 1, color: colors.muted, fontSize: 11, fontWeight: "800", letterSpacing: 0.7 },
    campaignTitle: { color: colors.bone, fontSize: 17, lineHeight: 20, fontWeight: "700", marginTop: 6 },
    campaignBody: { color: colors.muted, fontSize: 12, lineHeight: 16, marginTop: 4 },
    ...
    brandHeadGo: { color: colors.muted, fontSize: 22, marginTop: -2 },
    ...
    houseLine: { color: colors.muted, fontSize: 12, marginTop: 3 },
