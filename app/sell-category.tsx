...
import { LISTING_CATEGORIES, setPendingListingSelection } from "../lib/listingOptions";
  ...
  return (
    <View style={styles.page}>
      ...
      >
        ...
        <Text style={styles.heading}>What kind of piece is it?</Text>
        <Text style={styles.lede}>Choose one category so buyers can find it quickly.</Text>
          ...
          {LISTING_CATEGORIES.map((item) => {
            ...
            return (
              <AccessiblePressable
                ...
                accessibilityHint="Double tap to choose this category and return to your listing."
              >
