...
function make(colors: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    page: { flex: 1, backgroundColor: colors.ink }, content: { padding: 20, paddingBottom: 40 }, eyebrow: { color: colors.success, fontSize: 10, fontWeight: "900", letterSpacing: 1.8, marginTop: 10 }, title: { color: colors.bone, fontFamily: "Georgia", fontSize: 30, lineHeight: 36, marginTop: 10 }, body: { color: colors.muted, fontSize: 14, lineHeight: 21, marginTop: 8, marginBottom: 24 }, list: { gap: 10 }, option: { minHeight: 68, borderWidth: 1, borderColor: colors.subtle, borderRadius: 18, paddingHorizontal: 16, paddingVertical: 13, flexDirection: "row", alignItems: "center", backgroundColor: colors.surface }, optionSelected: { borderColor: colors.success, backgroundColor: "rgba(214,226,122,0.12)" }, optionLabel: { color: colors.bone, fontSize: 16, fontWeight: "800" }, optionLabelSelected: { color: colors.success }, optionCode: { color: colors.muted, fontSize: 11, marginTop: 3 }, optionCodeSelected: { color: colors.bone }, check: { width: 24, height: 24, borderRadius: 12, borderWidth: 1, borderColor: colors.subtle, color: "transparent", textAlign: "center", lineHeight: 22, fontWeight: "900" }, checkSelected: { backgroundColor: colors.success, borderColor: colors.success, color: colors.successInk }, current: { color: colors.muted, fontSize: 12, textAlign: "center", marginTop: 22 }
  });
}
