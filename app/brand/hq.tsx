...
export default function BrandHQ() {
  ...
  return (
    <View style={[styles.page, { backgroundColor: theme.bg }]}>
      ...
      <ScrollView ref={hqScroller} contentContainerStyle={[styles.content, { paddingTop: insets.top + 6, paddingBottom: insets.bottom + 240 }]} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" keyboardDismissMode={Platform.OS === "ios" ? "interactive" : "on-drag"}>
...
function MarketingCard({ item, manager, onToggle, onEdit, onDuplicate, onPreview, warnings = [], theme, styles }: { item: BrandCollection | BrandCampaign | BrandPromotion; manager: boolean; onToggle: () => void; onEdit?: () => void; onDuplicate?: () => void; onPreview?: () => void; warnings?: string[]; theme: HQTheme; styles: ReturnType<typeof make> }) {
