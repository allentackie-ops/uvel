...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    lede: { color: alpha(colors.bone, 0.58), fontSize: 15, lineHeight: 22, marginTop: 8, marginBottom: 18 },
    ...
    logoP: { color: alpha(colors.bone, 0.5), fontSize: 13, marginTop: 4 },
    label: { color: alpha(colors.bone, 0.45), fontSize: 12, marginTop: 16, letterSpacing: 0.3 },
    contactHint: { color: alpha(colors.bone, 0.55), fontSize: 13, lineHeight: 18, marginTop: 6 },
    contactState: { color: alpha(colors.bone, 0.45), fontSize: 12, marginTop: 8, lineHeight: 17 },
    field: {
      marginTop: 8,
      height: 48,
      borderRadius: 14,
    ...
    at: { color: alpha(colors.bone, 0.45), fontSize: 18, fontWeight: "700" },
    body: {
      marginTop: 8,
      minHeight: 110,
      borderRadius: 14,
    ...
    gateP: { color: alpha(colors.bone, 0.6), fontSize: 15, textAlign: "center", lineHeight: 22 },
    gateCta: {
      marginTop: 18,
      height: 48,
      paddingHorizontal: 28,
    ...
    doneP: { color: alpha(colors.bone, 0.58), textAlign: "center", lineHeight: 22, marginBottom: 12 },
    doneCta: {
      marginTop: 8,
      minHeight: 52,
