...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    logo: { width: 72, height: 72, borderRadius: 18, backgroundColor: "#161512" },
    logoEmpty: {
      width: 72,
      height: 72,
      borderRadius: 18,
    ...
    logoPlus: { color: "#F4F0E6", fontSize: 28 },
    ...
    section: { color: "#F4F0E6", fontFamily: "Georgia", fontSize: 22, marginTop: 28 },
    ...
    gateH: { color: "#F4F0E6", fontFamily: "Georgia", fontSize: 28, textAlign: "center", marginTop: 8 },
