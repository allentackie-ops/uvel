...
function make(colors: Colors) {
  ...
  kicker: { color: alpha(colors.bone, 0.42), letterSpacing: 1.6, fontSize: 11, fontWeight: "700", marginTop: 8 },
  title: { color: colors.bone, fontFamily: "Georgia", fontSize: 28, marginTop: 8, lineHeight: 34 },
  p: { color: alpha(colors.bone, 0.55), fontSize: 14, marginTop: 8, lineHeight: 20 },
  ...
  statL: { color: alpha(colors.bone, 0.5), fontSize: 12, marginTop: 4 },
  ...
  day: { color: alpha(colors.bone, 0.35), fontSize: 8, marginTop: 6 },
  legend: { color: alpha(colors.bone, 0.4), fontSize: 12, marginTop: 8 },
  ...
  rowP: { color: alpha(colors.bone, 0.5), fontSize: 12, marginTop: 3 },
  });
}
