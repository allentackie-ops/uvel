...
export default function LegalBrandApply() {
...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    logoPlus: { color: colors.bone, fontSize: 28 },
    logoH: { color: colors.bone, fontWeight: "700", fontSize: 16 },
    logoP: { color: `${colors.bone}80`, fontSize: 13, marginTop: 4 },
    label: { color: `${colors.bone}73`, fontSize: 12, marginTop: 16, letterSpacing: 0.3 },
    contactHint: { color: `${colors.bone}8C`, fontSize: 13, lineHeight: 18, marginTop: 6 },
    contactState: { color: `${colors.bone}73`, fontSize: 12, marginTop: 8, lineHeight: 17 },
    field: {
      marginTop: 8,
      height: 48,
      borderRadius: 14,
    ...
    at: { color: `${colors.bone}73`, fontSize: 18, fontWeight: "700" },
    body: {
      marginTop: 8,
      minHeight: 110,
      borderRadius: 14,
    ...
    section: { color: colors.bone, fontFamily: "Georgia", fontSize: 22, marginTop: 28 },
    ...
    cta: { height: 52, borderRadius: 26, backgroundColor: colors.success, alignItems: "center", justifyContent: "center" },
    ctaOff: { backgroundColor: colors.surface },
    ctaTxt: { color: colors.successInk, fontWeight: "800", fontSize: 16 },
    ctaTxtOff: { color: `${colors.bone}59` },
    gate: {
    ...
    gateH: { color: colors.bone, fontFamily: "Georgia", fontSize: 28, textAlign: "center", marginTop: 8 },
    gateP: { color: `${colors.bone}99`, fontSize: 15, textAlign: "center", lineHeight: 22 },
    gateCta: {
      marginTop: 18,
      height: 48,
      paddingHorizontal: 28,
    ...
    doneH: { color: colors.bone, fontFamily: "Georgia", fontSize: 28, textAlign: "center" },
    doneP: { color: `${colors.bone}94`, textAlign: "center", lineHeight: 22, marginBottom: 12 },
    doneCta: {
      marginTop: 8,
      minHeight: 52,
