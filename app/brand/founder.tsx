  ...
  return (
    <View>
      <View style={[styles.canvas, { backgroundColor: colors.card, borderColor: colors.lineColor }]} {...pan.panHandlers}>
        {importedImage ? <Image cachePolicy="memory-disk" pointerEvents="none" source={{ uri: importedImage.uri }} style={{ position: "absolute", left: 0, top: 0, right: 0, bottom: 0, opacity: 0.62 }} contentFit="contain" /> : null}
