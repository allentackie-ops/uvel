...
function DraftResumeNotice() {
  ...
  return (
    <View pointerEvents="box-none" style={{ position: "absolute", top: 58, left: 16, right: 16, zIndex: 100 }}>
      <View style={{ backgroundColor: colors.surface, borderColor: colors.success, borderWidth: 1, borderRadius: 18, padding: 16, shadowColor: "#000", shadowOpacity: 0.28, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 10 }}>
        <Text style={{ color: colors.success, fontSize: 11, fontWeight: "800", letterSpacing: 1.2 }}>DRAFT SAVED</Text>
        <Text style={{ color: colors.bone, fontSize: 17, fontWeight: "700", marginTop: 6 }}>Your listing draft was saved.</Text>
        <Text style={{ color: alpha(colors.bone, 0.62), fontSize: 13, lineHeight: 19, marginTop: 4 }}>Continue where you left off in your listing.</Text>
        <View style={{ flexDirection: "row", gap: 10, marginTop: 14 }}>
          <Pressable onPress={() => setVisible(false)} style={{ flex: 1, height: 42, borderRadius: 21, borderWidth: 1, borderColor: alpha(colors.bone, 0.2), alignItems: "center", justifyContent: "center" }}>
