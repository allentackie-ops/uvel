...
export default function FriendChat() {
  ...
  return <View style={styles.page}>
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      ...
      {photoUri ? <View style={styles.preview}><Image cachePolicy="memory-disk" source={{ uri: photoUri }} style={styles.previewImg} contentFit="cover" /><Text style={styles.previewTxt}>Photo ready</Text><Pressable onPress={() => setPhotoUri(undefined)} accessibilityRole="button" accessibilityLabel="Remove photo"><Text style={styles.remove}>×</Text></Pressable></View> : null}
