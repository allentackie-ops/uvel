...
export function ShopSkeleton({ colors }: { colors: Colors }) {
  return (
    <ScrollView style={[styles.page, { backgroundColor: colors.ink }]} contentContainerStyle={styles.shopContent} scrollEnabled={false}>
      ...
      <View style={[styles.search, { borderColor: colors.neutral }]}><Line width="100%" height={18} radius={8} /></View>
  ...
  return (
    <ScrollView style={[styles.page, { backgroundColor: colors.ink }]} contentContainerStyle={styles.todayContent} scrollEnabled={false}>
      ...
      <View style={styles.todayBody}>
        ...
        <View style={[styles.inbox, { borderColor: colors.neutral }]}><View style={{ flex: 1, gap: 8 }}><Line width={52} height={12} /><Line width="72%" height={14} /></View><Line width={26} height={26} radius={13} /></View>
...
export function BrandHQSkeleton({ colors }: { colors: Colors }) {
  return (
    <ScrollView style={[styles.page, { backgroundColor: colors.ink }]} contentContainerStyle={styles.hqContent} scrollEnabled={false}>
      ...
      <View style={styles.hqStats}>{Array.from({ length: 3 }, (_, index) => <View key={index} style={[styles.stat, { borderColor: colors.neutral }]}><Line width="54%" height={12} /><Line width="72%" height={22} /></View>)}</View>
      <View style={[styles.hqPanel, { borderColor: colors.neutral }]}><Line width="38%" height={17} /><Line width="92%" height={12} /><Line width="76%" height={12} /><Line width="84%" height={12} /></View>
      <Line width={132} height={18} />
      <View style={[styles.hqPanel, { borderColor: colors.neutral }]}><Line width="48%" height={17} /><Line width="96%" height={12} /><Line width="88%" height={12} /><Line width="72%" height={12} /></View>
      <View style={[styles.hqPanel, { borderColor: colors.neutral }]}><Line width="42%" height={17} /><Line width="90%" height={12} /><Line width="64%" height={12} /><Line width="82%" height={12} /></View>
    </ScrollView>
  );
}
