...
function make(colors: Colors) {
  return StyleSheet.create({
    ...
    breakdownItem: { marginTop: 18, padding: 14, borderRadius: 16, backgroundColor: colors.info, borderWidth: 1, borderColor: `${colors.bone}18` },
    ...
    sellerCard: { minHeight: 74, flexDirection: "row", alignItems: "center", gap: 12, padding: 14, marginTop: 22, borderRadius: 16, backgroundColor: colors.info, borderWidth: 1, borderColor: `${colors.bone}1C` },
    ...
    locationCard: { flex: 1, minHeight: 72, justifyContent: "center", gap: 6, paddingHorizontal: 13, paddingVertical: 11, borderRadius: 14, backgroundColor: colors.info, borderWidth: 1, borderColor: `${colors.bone}16` },
    ...
    policyDisclosure: { minHeight: 76, backgroundColor: colors.info, borderWidth: 1, borderColor: `${colors.bone}20`, borderRadius: 15, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", marginTop: 24, gap: 12 },
    ...
    policyDetails: { padding: 14, backgroundColor: colors.info, borderRadius: 15, borderWidth: 1, borderColor: `${colors.bone}20`, marginTop: 8 },
