...
function make(colors: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    ...
    framedImg: { borderRadius: 0, backgroundColor: colors.ink },
    ...
    badge: { position: "absolute", left: 10, bottom: 10, backgroundColor: colors.surface, paddingHorizontal: 12, height: 28, borderRadius: 14, alignItems: "center", justifyContent: "center" },
    badgeTxt: { color: colors.bone, fontWeight: "700", fontSize: 12 },
    ...
    stockBadgeTxt: { color: colors.successInk, fontSize: 11, fontWeight: "800" },
    ...
    brandFramed: { marginTop: 0, letterSpacing: 1.3, fontWeight: "700", color: colors.subtle },
    ...
    sizeLine: { color: colors.subtle, fontSize: 11, marginTop: 4, letterSpacing: 0.4 },
