...
function make(colors: Colors) {
  ...
  link: { color: alpha(colors.bone, 0.7), fontSize: 16 },
  title: { color: colors.bone, fontWeight: "600", fontSize: 16 },
  use: { color: colors.success, fontWeight: "700", fontSize: 16 },
  hint: { color: alpha(colors.bone, 0.5), textAlign: "center", fontSize: 13, marginBottom: 12 },
  ...
  busy: {
    ...
    backgroundColor: alpha(colors.success, 0.35),
    alignItems: "center",
