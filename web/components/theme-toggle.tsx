...
/** Static dark-mode indicator retained in the header without a theme switcher. */
...
/** Dark mode is fixed; this component is retained for settings-page compatibility. */
