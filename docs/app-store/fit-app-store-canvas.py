...
source = Path("/home/ubuntu/uvel/docs/app-store/uvel-saved-fits-app-store-promo.png")
target = Path("/home/ubuntu/uvel/docs/app-store/uvel-saved-fits-app-store-1290x2796.png")
