...
source = Path("/home/ubuntu/uvel/docs/app-store/uvel-app-store-carousel-white.png")
target = Path("/home/ubuntu/uvel/docs/app-store/uvel-app-store-carousel-white-1290x2796.png")
